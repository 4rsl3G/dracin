...
// HEADER SIMPLE (Meniru CURL Anda)
const PROXY_HEADERS = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36'
    // Kita hapus Referer & Origin karena di Curl tidak dipakai dan berhasil
};
...
async function fetchUpstream(endpoint) {
    ...
    try {
        ...
        // Jika error, kembalikan JSON kosong biar gak hang
        if (!response.ok) return { code: response.status, data: { list: [] } };
